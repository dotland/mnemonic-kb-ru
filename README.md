...
&nbsp;&nbsp;&nbsp;&nbsp;Также программа Keyman (на ОС-ах Windows, macOS и Linux) имеет «Character Map» для ввода символов [Юникод](https://unicode.org/standard/translations/russian.html).
