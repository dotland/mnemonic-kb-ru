...
&nbsp;&nbsp;&nbsp;&nbsp;Принимая во внимание вопрос дополнительных пробелов упомянутую в [примере](#примеры-выражений) выше, [вариант Keyman для ОС-ы Linux](#windows-macos-linux) предпочтительнее, чем этот.
