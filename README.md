...
| 7     | **Ё** &nbsp; **ё**    | ё               | *yo* ( *your* )           | `Y` `O` <br /> `"` `E` | п. указательный, п. безымянный <br /> п. мизинец, л. средний |
| 8     | **Ж** &nbsp; **ж**    | жэ              | *zh* ( *Zheravna* )       | `Z` `H` <br /> `'` `X` | л. мизинец, п. указательный <br /> п. мизинец, л. безымянный |
| 9     | **З** &nbsp; **з**    | зэ              | *z* ( *zero* )            | `Z`               | л. мизинец              |
| 10    | **И** &nbsp; **и**    | и               | *i* ( *literal* )         | `I`               | п. средний              |
| 11    | **Й** &nbsp; **й**    | и краткое       | *y* ( *yoga* )            | `Y`               | п. указательный         |
...
| 23    | **Х** &nbsp; **х**    | ха              | *kh* ( *Khakassia* )      | `X` <br /> `'` `K` | л. безымянный <br /> п. мизинец, п. средний  |
